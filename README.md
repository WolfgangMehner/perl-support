...
- No need to edit stock templates anymore
- The personalization/customization can be done in separate files,
  so there is no need to change stock templates.
- Setup wizard for personalization file
- More to come ...
